          ...
          <div class="max-w-2xl text-center mx-auto">
            ...
            <div class="mt-5 max-w-3xl">
              <p class="text-lg text-gray-600 dark:text-gray-400">
                ...
                business improve their online present which help s them generate
                more leads
              </p>
            </div>
            ...
            <div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
              ...
              <p class="text-slate-500">
                {/* Recevie a notfication when the site is launch and get 30%
                discount the first 50 customer to sign up */}
                Recevie a notfication on when the site is launch and get 30% OFF
                on the day first week
              </p>
